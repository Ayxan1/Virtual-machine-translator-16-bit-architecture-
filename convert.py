class Vm_to_assembly_converter:
    ...
    # Initialisations before translation all memory segments must point proper ram units.
    """
    ...
    def initialise_memory_segments(self):
        ...
        # set RAM[1] 300,   // base address of the local segment.
        assembly_code = '// Initialisation of local segment\n' +\
                        '@300\n' +                              \
                        'D=A\n'+                                \
                        '@1\n' +                                \
                        'M=D\n'
        ...
        # set RAM[2] 400,   // base address of the argument segment
        assembly_code = '// Initialisation of argument segment\n' +\
                        '@400\n' +                              \
                        'D=A\n'+                                \
                        '@2\n' +                                \
                        'M=D\n'
        ...
        # set RAM[3] 3000,  // base address of the this segment
        assembly_code = '// Initialisation of this segment\n' +\
                        '@3000\n' +                             \
                        'D=A\n'+                                \
                        '@3\n' +                                \
                        'M=D\n'
        ...
        # set RAM[4] 3010,  // base address of the that segment
        assembly_code = '// Initialisation of that segment\n' +\
                        '@3010\n' +                             \
                        'D=A\n'+                                \
                        '@4\n' +                                \
                        'M=D\n'
